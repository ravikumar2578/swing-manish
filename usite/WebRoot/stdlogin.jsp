...
<jsp:usebean id="bean4" scope="request" class="tarique.Login"/>
                      ...
                      <td align="center" valign=top bgcolor=#ffffff>                        <a href="javascript:;" target="_top" onClick="MM_nbGroup('down','group1','titleimage1','',1)" onMouseOver="MM_nbGroup('over','titleimage1','','',1)" onMouseOut="MM_nbGroup('out')">
                        ...
                        <table width="958" height="77" border="1">
                          <tr>
                            ...
                            <td width="594" align="center" valign="middle">
                            <form>
    <%
        try
        {
		...
		if(request.getParameter("loginname")!=null)
		{
			...
			ResultSet rs=st.executeQuery("select * from Login where loginname='"+uname+"'");
				if(rs.next())
				{
				...
				System.out.println(username+userpass);
					if(username.equals(uname)&&(userpass.equals(upass)))
					{
						...
						session.setAttribute("up",upass);
                    %>
                   <jsp:forward page="stdprofile.jsp" />        
                   	<%
                   	}
                   	else
                   	{
                   	session.setAttribute("inv","Invalid User & Pass word");
                   	%>
             		<jsp:forward page="stdprofile.jsp"></jsp:forward>
             		<%
             		}
             	} // third if end
        		else  // second if else
		...
		%>	
                            <table width="317" height="107" border="1" cellpadding="0" cellspacing="0" bordercolor="#000099">
                              <tr align="center" bgcolor="#000099">
                                <td colspan="2"><h3><span class="style2">STUDENT LOGIN </span></h3></td>
                                </tr>
                              <tr>
                                <td width="144">Login Name </td>
                                <td width="167"><input name="loginname" type="text">&nbsp;</td>
                              </tr>
                              <tr>
                                <td>Password</td>
