...
<% int roomid;
 ...
 <%String g;
   ...
   PreparedStatement stm=con.prepareStatement("select l.name, l.gender,l.age,u.caste,u.mtongue,u.education from  userprofile u,login l where  l.gender=? and l.email1=u.email1  and l.age between ? and ?");
  stm.setString(1,g);
  stm.setInt(2,a1);
  stm.setInt(3,a2);
